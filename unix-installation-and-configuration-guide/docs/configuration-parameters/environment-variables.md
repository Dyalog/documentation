...
|`DYALOG_EXTVAR_SUPPORTED`|This parameter is a Boolean value with a default value of 1. If set to 0, support for external variables is disabled.|
|`DYALOG_S32_SUPPORTED`|This parameter is a Boolean value with a default value of 1. If set to 0, support for small-span component files is disabled, and such files cannot be tied.|
