...
A configuration file is a text file, in JSON5 syntax, that holds configuration parameters and their values, and is portable across all platforms that Dyalog supports.
