...
This requires Link which is available by default. A custom version of Link can be used. See [DyalogLink](../../dyalog-configuration-guide/configuration-parameters/dyaloglink.md).
