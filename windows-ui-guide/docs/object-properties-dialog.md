...
The *COM Properties* tab applies only to a function in an OLEServer or ActiveXControl namespace. The tab is used to [define arguments and data types for an exported Method or Property](../interface-guide/ole-server/introduction.md#writing-an-apl-ole-server).
