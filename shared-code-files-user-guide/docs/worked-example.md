...
This annotated example demonstrates the use of some of the [_I-beam_ functions](../technical-details/#technical-reference.md) related to shared code files (examples of assimilate and detach are not included).
