...
The number of characters by which an edit window is staggered horizontally from the previous one.
...
Related parameters: [Edit_Offset_Y](edit-offset-y.md), [Edit_First_X](edit-first-x.md).
