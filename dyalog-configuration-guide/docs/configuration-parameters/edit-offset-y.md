...
The number of characters by which an edit window is staggered vertically from the previous one.
...
Related parameters: [Edit_Offset_X](edit-offset-x.md), [Edit_First_Y](edit-first-y.md).
