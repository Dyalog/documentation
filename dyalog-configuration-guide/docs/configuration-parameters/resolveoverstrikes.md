...
Whether an APL composite symbol can be entered using overstrikes.

Valid values are:

- `0` : overstrikes are disabled
- `1` : overstrikes are enabled

<!-- REVIEW(default): default value not present in the migrated source; confirm. -->

Related parameters: [OverstrikesPopup](overstrikespopup.md).
