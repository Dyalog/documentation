...
The initial horizontal position, in character units, of the first edit window; subsequent edit windows are staggered from it. Applies only in Classic Dyalog mode.
