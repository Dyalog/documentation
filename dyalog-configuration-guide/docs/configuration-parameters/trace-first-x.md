...
The initial horizontal position, in character units, of the first Trace window; subsequent Trace windows are staggered from it. Applies only in Classic Dyalog mode.
