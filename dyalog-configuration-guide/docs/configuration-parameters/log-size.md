...
The size of the Session log buffer. See [Specifying Size-related Parameters](configuration-parameters.md) for how to give a valid size. The maximum is 2 GB.

<!-- REVIEW(default): default value not present in the migrated source; confirm per operating system. -->

Related parameters: [Log_File](log-file.md), [Log_File_InUse](log-file-inuse.md).
