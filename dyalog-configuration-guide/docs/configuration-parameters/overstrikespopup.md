...
Whether the Overstrikes popup is enabled.

Valid values are:

- `0` : the Overstrikes popup is disabled
- `1` : the Overstrikes popup is enabled

<!-- REVIEW(default): default value not present in the migrated source; confirm. -->

Related parameters: [ResolveOverstrikes](resolveoverstrikes.md).
