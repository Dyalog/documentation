...
Parameter names are not case-sensitive when given on the command line, in configuration files, or in the Windows Registry. When a parameter is set as an environment variable on Unix, its name is given in upper case.
