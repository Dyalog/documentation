...
# <span>SessionPrint</span> <span>Event 526</span>
...
!!! Hint "Hints and Recommendations"
    This event might be extended in future; in particular the number of elements in the event message might be increased, and the event might be generated by some system commands. You should therefore allow for such extensions in any code which refers to SessionPrint.
