...
You may convert dates between [IDN](../miscellaneous/international-day-number.md) and `⎕TS` representations using the [IDNToDate](../methodorevents/idntodate.md) and [DateToIDN](../methodorevents/datetoidn.md) methods. These methods apply to **all** objects and not just to the Calendar object itself.
