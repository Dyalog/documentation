...
An OLEServer may be saved as an [*out-of-process* OLE server](../../interface-guide/ole-server/out-of-process-ole-servers.md) (in a
workspace) or as an [*in-process* OLE server](../../interface-guide/ole-server/in-process-ole-servers.md) (in a DLL).
