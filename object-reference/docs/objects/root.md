...
For further information, see [The Options Menu](../../../windows-ui-guide/session-menubar), [ PropertyExposeRoot](../../../dyalog-configuration-guide/configuration-parameters/configuration-parameters), and [Expose Root Properties](../../../language-reference-guide/primitive-operators/i-beam/expose-root-properties).
