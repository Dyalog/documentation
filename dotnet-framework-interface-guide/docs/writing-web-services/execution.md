...
The [isolation mode](../implementation-details/isolation-mode.md) selected has implications for the way that you access and manage global resources such as component files.
