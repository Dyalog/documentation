...
- If execution in the Dyalog DLL is suspended, you cannot execute [`)CLEAR`](../../../language-reference-guide/system-commands/clear/) or [`)RESET`](../../../language-reference-guide/system-commands/reset/). You can execute `)OFF` or [`⎕OFF`](../../../language-reference-guide/system-functions/off/), but doing so will cause the client application to terminate. If you attempt to close the APL Session window, you will be warned that this will terminate the client application.
