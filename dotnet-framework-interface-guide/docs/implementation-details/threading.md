...
!!! Info "Information"
    Whether running as DYALOG.EXE, or as the Dyalog DLL, the Dyalog interpreter executes in a _single system thread_. However, APL does provide the ability to run several APL threads at the same time. See the _Dyalog APL Programming Reference Guide_ for more information on [APL threads](../../programming-reference-guide/threads/multithreading-overview.md).
