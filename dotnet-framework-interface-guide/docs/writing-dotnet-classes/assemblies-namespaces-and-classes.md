...
If a class is to be based upon a specific .NET class, then the name of that .NET class must be specified as the base class in the [`:Class`](../../../programming-reference-guide/defined-functions-and-operators/traditional-functions-and-operators/control-structures/class/) statement, and the [`:Using`](../../../programming-reference-guide/defined-functions-and-operators/traditional-functions-and-operators/control-structures/using/) statements must correctly locate the base class. Otherwise, the class is assumed to be based on <code class="language-nonAPL">System.Object</code>. If you use any .NET types within your class, you must ensure that these too are located by `:Using`.
