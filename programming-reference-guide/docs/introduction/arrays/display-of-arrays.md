...
To enable the display of output using array notation when starting a Dyalog session, set the [APLAN_FOR_OUTPUT](../../../dyalog-configuration-guide/configuration-parameters/aplan-for-output.md) configuration parameter to `1`.
