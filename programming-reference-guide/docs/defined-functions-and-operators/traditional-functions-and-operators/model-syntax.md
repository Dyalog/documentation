...
The right argument `Y` and/or the result `R` can be represented by a single name, or as a blank-delimited list of names surrounded by parentheses. For further details, see [Namelists](namelists.md).
