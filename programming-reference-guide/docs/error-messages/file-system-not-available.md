...
# <span>FILE SYSTEM NOT AVAILABLE</span> `28`

This error is generated if the operation system generates an unexpected error when attempting to get a lock on a component file.  See [Component Files](../introduction/component-files.md) for details.
