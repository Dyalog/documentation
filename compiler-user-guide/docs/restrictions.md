...
For global names, callbacks from `400⌶` enable the compiler to identify the nameclass (see [xxx](xxx)).
...
The compiler prohibits the use of __execute__ (`⍎`) because it could have arbitrary side effects unknown to the compiler.
