...
To install an out-of-process COM Server you must [set up the appropriate Windows registry entries](../interface-guide/ole-server/out-of-process-ole-servers.md#registry-entries).
