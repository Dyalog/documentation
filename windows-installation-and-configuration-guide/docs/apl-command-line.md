...
The command line for Dyalog APL is described below; the command line for non-Windows versions of Dyalog APL is very similar and is also documented under [Starting APL](../unix-user-guide/starting-apl.md) in the *Dyalog for UNIX User Guide*.
