...
The function executes the expression in `Y` exactly as it would be executed by the monadic _execute_ primitive function `⍎`, but handles [shy](../../../../programming-reference-guide/introduction/results#shy-results) results  of the execution rather differently.
