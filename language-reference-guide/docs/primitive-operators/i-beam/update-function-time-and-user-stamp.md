...
The [shy](../../../../programming-reference-guide/introduction/results) result `R` is a vector of numeric items, one per each specified function containing the following values:
