...
`Y` is an integer vector that would be a valid right argument to [`⎕NL`](../../system-functions/nl-monadic.md); it identifies the nameclasses and subclasses for which the names should be listed.
