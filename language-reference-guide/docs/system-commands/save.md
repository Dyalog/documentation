...
If an extension is not specified, an extension is added according to the [**WSEXT** parameter](../../dyalog-configuration-guide/configuration-parameters/configuration-parameters.md)..
