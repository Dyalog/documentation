...
When the shell is closed, control returns to APL. Further information about [calling UNIX commands from Dyalog](../../unix-user-guide/calling-unix-commands.md) is provided in the UNIX User Guide.
