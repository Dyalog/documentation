...
The fully qualified path of the file or directory loaded at startup. This is set by either a workspace name on the [APL command line](../../../windows-installation-and-configuration-guide/apl-command-line) or using the [LOAD configuration parameter](../../../dyalog-configuration-guide/configuration-parameters/load/).
