...
This system function offers to share one or more variables with another APL workspace or with another application.  Shared variables are implemented using [Dynamic Data Exchange (**DDE**)](../../interface-guide/dde/introduction.md) and may be used to communicate with any other application that supports this protocol.
