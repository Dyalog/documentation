...
If `Y` refers to a non-existent property, or to a property that is not defined for the type of the object, or to a property whose value cannot be changed by `⎕WS`, a `DOMAIN ERROR` is reported.
