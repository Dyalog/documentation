...
`R` is a vector of numbers on which a monitor has been placed in ascending order.  The result is [shy](../../../programming-reference-guide/introduction/results). `R` will be empty for dfns and dops.
