...
The [shy](../../../programming-reference-guide/introduction/results) result `R` is `Y`. To unlock the file, this value should subsequently be supplied in the right argument to `0 ⎕NLOCK`.
