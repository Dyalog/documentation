...
The [shy](../../../programming-reference-guide/introduction/results) result is the location of the internal file pointer which will be pointing to the end of the newly written data.
