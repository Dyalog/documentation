...
The value of `⎕PW` in a clear workspace is defined by the [**Default_PW**](../../../dyalog-configuration-guide/configuration-parameters/default-pw) parameter, which is `76` on Microsoft Windows and `79` on UNIX and macOS.
