...
|---|---|---|
|1|Function result|0 if the function has no result 1 if the function has an explicit result `¯1` if the function has a [shy](../../../programming-reference-guide/introduction/results) result|
