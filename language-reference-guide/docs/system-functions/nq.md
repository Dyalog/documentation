...
If `X` is 2 and the name supplied is the name of a (Dyalog APL) method, `⎕NQ` invokes the method.  Its ([shy](../../../programming-reference-guide/introduction/results)) result is the result produced by the method.
