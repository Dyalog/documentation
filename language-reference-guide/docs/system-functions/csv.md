...
If `Y` specifies that the CSV data is written to a file then `R` is the number of bytes (not characters) written, and is [shy](../../../programming-reference-guide/introduction/results).
